...
sections = [('2.5x2.5x1/2', 1.55, 0.806, 0.5, 0.739, 2.5),
            ('3x2x1/4', 1.19, 0.493, 0.25, 0.957, 3),
            ('3x2.5x1/2', 2.5, .75, .5, .913, 3),
            ('3x3x1/4', 1.44, .842, .25, 0.93, 3),
            ('4x3x1/2', 3.25, .827, 0.5, 1.23, 4),
